...
#         print(class(keq))
#         print(substrat)
#         print(class(substrat))
#         print(product)
#         print(class(product))
#         print(km_substrat)
#         print(class(km_substrat))
#         print(km_product)
#         print(class(km_product))
#         print(stochio_substrat)
#         print(class(stochio_substrat))
#         print(stochio_produit)
#         print(class(stochio_produit))
        print(MM_G_aide(kcat,keq,substrat, product, km_substrat, km_product, stochio_substrat, stochio_produit))
        print(matrix_phi[numReact,1])
      }
    }
    else{
